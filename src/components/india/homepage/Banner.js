      ...
      >
        ...
        <div className="relative h-full text-white">
          <div className="container h-full p-4 md:p-0">
            <div className="flex flex-col items-center justify-center w-full h-full space-y-4 md:space-y-8 text-center">
              ...
              <div className="absolute left-0 w-48 h-48 md:w-64 md:h-64 bg-gradient-to-br from-orange/20 via-primary/10 to-transparent rounded-full blur-3xl -z-10"></div>
              <div className="absolute right-0 w-48 h-48 md:w-64 md:h-64 bg-gradient-to-bl from-primary/20 via-orange/10 to-transparent rounded-full blur-3xl -z-10"></div>
            </div>
          </div>
        </div>
      </div>
